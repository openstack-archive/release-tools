...
# the branch for merges.
#
# To view open reviews for stable/icehouse 2014.1.4:
#
#   stable-freeze.py -r 2014.1.4 query
#
# Freeze all open reviews:
#
#  stable-freeze.py -r 2014.1.4 -o ~/openstack/2014.1.4-freeze.txt
#
# 2014.1.4-freeze.txt will store all frozen reviews and this can be used
# to thaw later on:
#
#  stable-freeze -r 2014.1.4 -i ~/openstack/2014.1.4-freeze.txt thaw
#
# If a review(s) comes in post-freeze and you'd like to -2 it and add it to
# list of frozen reviews:
#
#  stable-freeze -r 2014.1.4 -i ~/openstack/2014.1.4-freeze.txt \
...
def run_command(cmd):
    _cmd = [
        'ssh', '-p', '29418', '%s@review.openstack.org' % GERRIT_USER,
        'gerrit'
    ]
    _cmd += cmd
    if 'query' in _cmd:
