...
parser.add_argument('--inreview', action='store_true',
...
if args.inreview:
    ...
    try:
        ...
        if r.status_code == 200 and r.text:
            parser.error("The spec you want to set --inreview seems to "
...
unapproved BP, don't forget the --inreview parameter.
