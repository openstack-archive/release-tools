...
function usage {
    echo "Usage: release.sh [-a] repository series version SHA announce include_pypi extra-metadata"
    echo
    echo "Example: release.sh openstack/oslo.rootwrap mitaka 3.0.3 gerrit/master openstack-dev@lists.openstack.org yes 'meta:release:Workflow+1: Doug Hellmann <doug@doughellmann.com>'"
}
